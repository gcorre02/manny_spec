# Ongoing Thoughts (Non-canonical)

Personal ideation notepad. Promoted material lives in `canonical/high_level/` (north-star) and `canonical/*_v1.1.md` (contract).

- **Locality via activation fronts:** threads operate on an *active k-hop frontier* seeded by an initial activation; no global scans. Neighbor expansion is driven by local edge strength (κ) + lens weights + novelty/valence bias.
