...
- `canonical/foundations_v1.1.md`: threads-as-thought, no hidden planners, explanation == path.
- `canonical/design_document_v1.1.md`: Gate A (path coverage + `/why` fidelity).
- `canonical/architecture_v1.1.md`: core engine is source of truth; interfaces are transport only.
- `canonical/validation/validation_framework.md`: pack format, artifacts, report schema.
