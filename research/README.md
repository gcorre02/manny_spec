# research/ (reference, non-canonical)

Purpose: keep historical and exploratory materials organized. These files are reference only and do not override the canonical docs.

## Folders
- `surveys_analysis/` — landscape surveys and comparative analyses (still useful context).
- `validation/` — legacy validation ideas/dossiers (superseded by `canonical/validation/`, kept for reference).
